	...
	return (
		<div className="flex flex-col gap-8 px-4">
			...
			<section className="my-8">
				...
				<a
					href="/article"
					className="underline-offset-3 flex items-center mx-auto justify-center text-zinc-400 hover:text-foreground w-fit underline"
				>
				...
				<div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3">
					{latestArticles.map((article) => (
						<Card key={article.id} className="bg-zinc-900/50 p-0 aspect-square">
							<a href={`/article/${article.id}`}>
								<CardContent className="grid aspect-[4/3] place-items-center text-zinc-400 hover:text-foreground bg-zinc-950 rounded-t-xl">
